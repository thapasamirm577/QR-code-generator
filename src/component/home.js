            ...
            <main className={classes.home_main_container}>
                <section className={classes.home_section}>
                    ...
                    <article className={classes.home_qr_body}>
                        <form onSubmit={handleSubmit}>
                            <div className={classes.indv_label}>
                                <label htmlFor='text'>
                                    Your text or url to make QR code
                                </label>
                            </div>
                            <div className={classes.indv_input}>
                                <input type="text" id='text' name='text' placeholder='Enter text or paste url' value={data} onChange={handleChange} />
                            </div>
                            <div className={classes.indv_btn}>
                                <button onClick={(e)=>{setInfo(!info)}}>Generate</button>
                            </div>
                        </form>
                    </article>
                    ...
                    <article className={classes.result_qr_container}>
                        <header className={classes.result_qr_header}>
                            Your QR Code
                        </header>
